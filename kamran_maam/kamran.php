...
{
echo "<script type='text/javascript'>alert('message not send.Please fill al fields');
 location.replace('https://testform00000001.000webhostapp.com/kamran.php/')
</script>";
}
...
mail("kamran.ahmad@mmumullana.org", "Appointment Request", " Name:  $name \nEmail: $email \nMobile Number: $num \nMessage: $appointment_description \nDate: $date \nTime: $time \nDuration: $duration \n",  "From: $name <$email>");
